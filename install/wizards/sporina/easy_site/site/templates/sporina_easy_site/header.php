...
$font = $appearance['fontKey'];
$textSize = $appearance['textSize'];
$headingSize = $appearance['headingSize'];
$buttonEffect = $appearance['buttonEffect'];
$buttonEffects = $appearance['buttonEffects'];
$mobileHeaderColor = $appearance['mobileHeaderColor'];
$mobileHeaderFixed = $appearance['mobileHeaderFixed'];
$mobileHeaderHideOnScroll = $mobileHeaderFixed && $appearance['mobileHeaderHideOnScroll'];
?>
<!DOCTYPE html>
  ...
  <title><?$APPLICATION->ShowTitle();?></title>
    ...
    <script>
      (function () {
        ...
        var effectClasses = <?=json_encode($buttonEffects)?>;
