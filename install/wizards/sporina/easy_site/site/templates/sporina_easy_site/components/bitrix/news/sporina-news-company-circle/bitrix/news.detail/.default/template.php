...
?>
<article class="news-company-circle-detail">
	<div class="news-company-circle-detail__hero<?=($heroPicture !== null ? " news-company-circle-detail__hero--with-media" : "")?>">
		<div class="news-company-circle-detail__hero-content">
			<?if($displayDate !== ""):?>
				<div class="news-company-circle-detail__meta">
					<span class="news-company-circle-detail__date"><?=$displayDate?></span>
				</div>
			<?endif;?>

			<?if($arParams["DISPLAY_NAME"] != "N" && !empty($arResult["NAME"])):?>
				<h1 class="news-company-circle-detail__title"><?=$arResult["NAME"]?></h1>
			<?endif;?>

			<?if($previewText !== ""):?>
				<div class="news-company-circle-detail__lead"><?=$previewText?></div>
			<?endif;?>
		</div>

		<?if($heroPicture !== null):?>
			<div class="news-company-circle-detail__hero-media">
				<img
					class="news-company-circle-detail__image"
					src="<?=$heroPicture["SRC"]?>"
	...
	<div class="news-company-circle-detail__body">
	...
	<?if(!empty($detailProperties)):?>
		<div class="news-company-circle-detail__properties">
			<?foreach($detailProperties as $property):?>
				<div class="news-company-circle-detail__property">
					<div class="news-company-circle-detail__property-name"><?=$property["NAME"]?></div>
					<div class="news-company-circle-detail__property-value"><?=$property["VALUE"]?></div>
				</div>
			<?endforeach;?>
		</div>
	<?endif;?>
	...
	<?if(array_key_exists("USE_SHARE", $arParams) && $arParams["USE_SHARE"] == "Y"):?>
		<div class="news-company-circle-detail__share">
			<noindex>
