...
$availableTemplates = array('accordion');
$listTemplate = isset($arParams['NEWS_LIST_TEMPLATE']) ? (string)$arParams['NEWS_LIST_TEMPLATE'] : 'accordion';
if (!in_array($listTemplate, $availableTemplates, true)) $listTemplate = 'accordion';
...
$APPLICATION->IncludeComponent('bitrix:news.list', $listTemplate, array_merge($arParams, array(
    ...
    'FIELD_CODE' => $arParams['LIST_FIELD_CODE'], 'PROPERTY_CODE' => $propertyCodes, 'DETAIL_URL' => $arResult['FOLDER'].$arResult['URL_TEMPLATES']['detail'],
    ...
    'PAGER_SHOW_ALWAYS' => $arParams['PAGER_SHOW_ALWAYS'], 'PAGER_DESC_NUMBERING' => $arParams['PAGER_DESC_NUMBERING'], 'PAGER_SHOW_ALL' => $arParams['PAGER_SHOW_ALL'], 'CHECK_DATES' => $arParams['CHECK_DATES']
)), $component);
