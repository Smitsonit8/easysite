...
if ($arResult["BACKGROUND_IMAGE_SRC"] !== "")
{
	...
	$bannerStyle = "background-image: linear-gradient(90deg, rgba(7, 52, 94, 0.72), rgba(14, 118, 173, 0.62)), url('".$backgroundImage."'); background-position: center, center; background-repeat: no-repeat, no-repeat; background-size: auto, cover;";
}
?>
	...
	<div class="container sporina-banner-compact__container">
		<div class="sporina-banner-compact__content">
			...
			<?php if ($arResult["SHOW_BUTTON"]): ?>
				<a class="button sporina-banner-compact__button" href="<?=htmlspecialcharsbx($arResult["BUTTON_LINK"])?>">
			...
			<div class="sporina-banner-compact__media">
				<picture>
					<?php if ($arResult["MOBILE_IMAGE_SRC"] !== ""): ?>
						<source srcset="<?=htmlspecialcharsbx($arResult["MOBILE_IMAGE_SRC"])?>" media="(max-width: 767px)">
					<?php endif; ?>
