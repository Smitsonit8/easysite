...
final class Settings
{
    ...
    private const DEFINITIONS = [
        ...
        ['key' => 'template-button-effect', 'category' => 'template', 'categoryTitle' => 'Оформление', 'label' => 'Эффект кнопок', 'type' => 'select', 'default' => 'btn-effect-1', 'values' => ['btn-effect-1' => 'Эффект 1', 'btn-effect-2' => 'Эффект 2', 'btn-effect-3' => 'Эффект 3', 'btn-effect-4' => 'Эффект 4', 'btn-effect-5' => 'Эффект 5']],
    ...
    public static function getAppearance(string $profile = self::DEFAULT_PROFILE): array
    {
        ...
        return [
            ...
            'fontKey' => $settings['template-font'],
            'fontFamily' => $font['values'][$settings['template-font']]['appearance'],
            'textSize' => $settings['typography-text-size'],
            'headingSize' => $settings['typography-heading-size'],
            'buttonEffect' => $settings['template-button-effect'],
            'buttonEffects' => array_keys($buttonEffects['values']),
            'lazyloadUse' => $settings['template-images-lazyload-use'],
            'headerTemplate' => $settings['header-template'],
            'mobileHeaderColor' => $settings['mobile-header-color'],
            'mobileHeaderFixed' => $settings['mobile-header-fixed'] === 'Y',
            'mobileHeaderHideOnScroll' => $settings['mobile-header-hide-on-scroll'] === 'Y',
        ];
    }
