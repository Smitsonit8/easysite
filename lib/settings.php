...
final class Settings
{
    ...
    private const DEFINITIONS = [
        ...
        ['key' => 'pages-main-banner-template', 'category' => 'main-page', 'categoryTitle' => 'Главная страница', 'label' => 'Шаблон баннера', 'type' => 'select', 'default' => '.default', 'values' => ['.default' => 'Стандартный', 'centered' => 'По центру', 'compact' => 'Компактный'], 'templatePath' => 'sporina/banner/templates', 'sourceBinding' => ['scope' => 'site', 'file' => 'index_inc.php', 'component' => 'sporina:banner', 'parameter' => 'COMPONENT_TEMPLATE', 'target' => 'component-template'], 'previewRatio' => '7 / 2', 'previews' => ['.default' => 'images/properties/banner/default.png', 'centered' => 'images/properties/banner/centered.png', 'compact' => 'images/properties/banner/compact.png']],
        ...
        ['key' => 'pages-main-current-news-template', 'category' => 'main-page', 'categoryTitle' => 'Главная', 'label' => 'Шаблон актуальных новостей', 'type' => 'select', 'default' => 'sporina-news-all-modern', 'values' => ['sporina-news-all' => 'Обычный', 'sporina-news-all-modern' => 'Современный'], 'templatePath' => 'bitrix/news.index', 'sourceBinding' => ['scope' => 'site', 'file' => 'index.php', 'component' => 'bitrix:news.index', 'parameter' => 'COMPONENT_TEMPLATE', 'target' => 'component-template'], 'previewRatio' => '16 / 3', 'previews' => ['sporina-news-all' => 'images/properties/current_news/sporina-news-all.png', 'sporina-news-all-modern' => 'images/properties/current_news/sporina-news-all-modern.png']],
    ];
