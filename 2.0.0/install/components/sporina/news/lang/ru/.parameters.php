<?
$MESS["SPORINA_NEWS_FORM_SETTINGS"] = "Форма заказа";
$MESS["SPORINA_NEWS_FORM_SHOW"] = "Показывать форму на детальной странице";
$MESS["SPORINA_NEWS_FORM_ID"] = "ID веб-формы";
$MESS["SPORINA_NEWS_FORM_TEMPLATE"] = "Шаблон компонента веб-формы";
$MESS["SPORINA_NEWS_FORM_SUCCESS_URL"] = "URL после успешной отправки";
$MESS["SPORINA_NEWS_FORM_PERSONAL_DATA_URL"] = "Ссылка на документ об обработке персональных данных";
$MESS["SPORINA_NEWS_FORM_USE_EXTENDED_ERRORS"] = "Показывать расширенные ошибки";
