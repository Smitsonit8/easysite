...
$arComponentParameters = [
	"GROUPS" => [
		...
		"FORM_SETTINGS" => [
			"SORT" => 160,
			"NAME" => GetMessage("SPORINA_NEWS_FORM_SETTINGS"),
		],
	],
	"PARAMETERS" => [
		"FORM_SHOW" => [
			"PARENT" => "FORM_SETTINGS",
			"NAME" => GetMessage("SPORINA_NEWS_FORM_SHOW"),
			"TYPE" => "CHECKBOX",
			"DEFAULT" => "Y",
		],
		"FORM_ID" => [
			"PARENT" => "FORM_SETTINGS",
			"NAME" => GetMessage("SPORINA_NEWS_FORM_ID"),
			"TYPE" => "STRING",
			"DEFAULT" => "",
		],
		"FORM_TEMPLATE" => [
			"PARENT" => "FORM_SETTINGS",
			"NAME" => GetMessage("SPORINA_NEWS_FORM_TEMPLATE"),
			"TYPE" => "STRING",
			"DEFAULT" => "sporina-form-order",
		],
		"FORM_SUCCESS_URL" => [
			"PARENT" => "FORM_SETTINGS",
			"NAME" => GetMessage("SPORINA_NEWS_FORM_SUCCESS_URL"),
			"TYPE" => "STRING",
			"DEFAULT" => "",
		],
		"FORM_PERSONAL_DATA_URL" => [
			"PARENT" => "FORM_SETTINGS",
			"NAME" => GetMessage("SPORINA_NEWS_FORM_PERSONAL_DATA_URL"),
			"TYPE" => "STRING",
			"DEFAULT" => "",
		],
		"FORM_USE_EXTENDED_ERRORS" => [
			"PARENT" => "FORM_SETTINGS",
			"NAME" => GetMessage("SPORINA_NEWS_FORM_USE_EXTENDED_ERRORS"),
			"TYPE" => "CHECKBOX",
			"DEFAULT" => "N",
		],
		"VARIABLE_ALIASES" => [
